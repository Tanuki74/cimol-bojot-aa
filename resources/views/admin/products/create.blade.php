...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-[#9D3706] overflow-hidden border border-3 border-[#700E0E] shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-white">Tambah Produk</h2>
                </div>
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-yellow-300">Product Name</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-yellow-300">Product Image</label>
                        <p class="text-sm text-yellow-300 mb-1">Hanya file gambar yang diperbolehkan (jpg, jpeg, png, gif, svg). Maksimal ukuran 2MB.</p>
